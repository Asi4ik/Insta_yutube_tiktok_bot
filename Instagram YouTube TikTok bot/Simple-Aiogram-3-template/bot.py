...
async def instagram_download(message:Message):
    ...
    if result[0]=="video":
        await message.answer_video(video=result[1],caption="Admin: @Azimov_Asliddin")
    elif result[0]=="rasm":
        await message.answer_photo(photo=result[1], caption="Admin: @Azimov_Asliddin")
    else:
...
async def youtube_download(message:Message):
    ...
    await message.answer_video(video=video, caption="ADMIN: @Azimov_Asliddin")
